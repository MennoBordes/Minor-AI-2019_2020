...
class XplaneENV(gym.Env):
    ...
    def reached_waypoint(self, state):
        ...
        close_latitude = math.isclose(state[0], self.waypoints[self.waypoint_goal][0], abs_tol=0.009)
        close_longitude = math.isclose(state[1], self.waypoints[self.waypoint_goal][1], abs_tol=0.009)
    ...
    def reached_goal(self, state):
        ...
        close_latitude = math.isclose(state[0], self.last_waypoints[0], abs_tol=0.009)
        close_longitude = math.isclose(state[1], self.last_waypoints[1], abs_tol=0.009)
