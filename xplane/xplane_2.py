...
class XPlaneUdp:
    ...
    def AddAbles(self, altitude=False, position=False, speed=False):
        ...
        # self.AddDataReader("sim/operation/failures/rel_tire1")
        # self.AddDataReader("sim/operation/failures/rel_tire2")
        # self.AddDataReader("sim/operation/failures/rel_tire3")
        # self.AddDataReader("sim/operation/failures/rel_tire4")
        # self.AddDataReader("sim/operation/failures/rel_tire5")
        self.AddDataReader("sim/flightmodel2/gear/on_ground")
        self.AddDataReader("sim/flightmodel/failures/onground_any")
